...
function getWidgetAttribute(component) {
  ...
  if (component.props.children) {
    (0, _invariant.invariant)(_react.default.Children.count(component.props.children) === 1, "<DynamicWidgets> only supports a single component in nested components. Make sure to not render multiple children in a parent component.\n\nExample of an unsupported scenario:\n\n```\n<DynamicWidgets>\n  <MyComponent>\n    <RefinementList attribute=\"brand\" />\n    <Menu attribute=\"categories\" />\n  </MyComponent>\n</DynamicWidgets>\n```\n");
    return getWidgetAttribute(_react.default.Children.only(component.props.children));
  }
